...
class EsitoMessaggioModel(BaseModel):
    ...
    parametri: Optional[List[Any]] = Field(default=None, description="Parametri del messaggio")
    __properties: ClassVar[List[str]] = ["indice", "campo", "tipo", "codice_messaggio", "parametri"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.indice is None and "indice" in self.model_fields_set:
            _dict['indice'] = None

        # set to None if campo (nullable) is None
        # and model_fields_set contains the field
        if self.campo is None and "campo" in self.model_fields_set:
            _dict['campo'] = None

        # set to None if codice_messaggio (nullable) is None
        # and model_fields_set contains the field
        if self.codice_messaggio is None and "codice_messaggio" in self.model_fields_set:
            _dict['codice_messaggio'] = None

        # set to None if parametri (nullable) is None
        # and model_fields_set contains the field
        if self.parametri is None and "parametri" in self.model_fields_set:
