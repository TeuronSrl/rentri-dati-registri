...
class DatiTrasportatoreModel(BaseModel):
    """
    Trasportatore  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DatiTrasportatoreModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DatiTrasportatoreModel:
        """Create an instance of DatiTrasportatoreModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DatiTrasportatoreModel.parse_obj(obj)

        _obj = DatiTrasportatoreModel.parse_obj({
