...
class EsitoMovimentiBaseModel(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EsitoMovimentiBaseModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EsitoMovimentiBaseModel:
        """Create an instance of EsitoMovimentiBaseModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EsitoMovimentiBaseModel.parse_obj(obj)

        _obj = EsitoMovimentiBaseModel.parse_obj({
