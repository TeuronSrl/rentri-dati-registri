...
class UnitaMisuraPesoQuantitaModel(BaseModel):
    ...
    unita_misura: UnitaMisuraPeso = Field(description="Unità di misura della quantità  Vedi API di codifica: <i>GET /codifiche/v1.0/unita-misura</i><p>Valori ammessi:<ul style=\"margin:0\"><li><i>kg</i> - Chilogrammi</li></ul></p>")
