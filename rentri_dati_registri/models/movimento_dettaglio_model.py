...
class MovimentoDettaglioModel(BaseModel):
    ...
    variazioni: Optional[List[DatiMovimentoModel]] = Field(default=None, description="Variazioni")
    __properties: ClassVar[List[str]] = ["riferimenti", "rifiuto", "materiali", "integrazione_fir", "esito", "produttore", "trasportatore", "destinatario", "intermediario", "intermediari", "annotazioni", "annullato", "rettificato", "variazioni"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.variazioni:
            for _item_variazioni in self.variazioni:
                if _item_variazioni:
                    _items.append(_item_variazioni.to_dict())
        ...
        # and model_fields_set contains the field
        if self.variazioni is None and "variazioni" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "riferimenti": DatiRiferimentiCompletoModel.from_dict(obj["riferimenti"]) if obj.get("riferimenti") is not None else None,
            ...
            "variazioni": [DatiMovimentoModel.from_dict(_item) for _item in obj["variazioni"]] if obj.get("variazioni") is not None else None
        })
        return _obj
