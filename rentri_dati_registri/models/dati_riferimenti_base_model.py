...
class DatiRiferimentiBaseModel(BaseModel):
    ...
    """
    numero_registrazione: DatiRiferimentiBaseModelNumeroRegistrazione = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DatiRiferimentiBaseModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DatiRiferimentiBaseModel:
        """Create an instance of DatiRiferimentiBaseModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DatiRiferimentiBaseModel.parse_obj(obj)

        _obj = DatiRiferimentiBaseModel.parse_obj({
            "numero_registrazione": DatiRiferimentiBaseModelNumeroRegistrazione.from_dict(obj.get("numero_registrazione")) if obj.get("numero_registrazione") is not None else None,
