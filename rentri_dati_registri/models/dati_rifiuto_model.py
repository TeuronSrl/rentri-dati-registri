...
class DatiRifiutoModel(BaseModel):
    ...
    __properties = ["codice_eer", "descrizione_eer", "provenienza", "caratteristiche_pericolo", "stato_fisico", "quantita", "destinato_attivita", "categorie_aee", "veicolo_fuori_uso", "veicolo_fuori_uso_reg_pubblica_sicurezza"]
    ...
    def to_dict(self):
        ...
        if self.descrizione_eer is None and "descrizione_eer" in self.__fields_set__:
            _dict['descrizione_eer'] = None

        # set to None if provenienza (nullable) is None
        # and __fields_set__ contains the field
        if self.provenienza is None and "provenienza" in self.__fields_set__:
        ...
        # and __fields_set__ contains the field
        if self.destinato_attivita is None and "destinato_attivita" in self.__fields_set__:
            _dict['destinato_attivita'] = None

        # set to None if categorie_aee (nullable) is None
        # and __fields_set__ contains the field
        if self.categorie_aee is None and "categorie_aee" in self.__fields_set__:
            _dict['categorie_aee'] = None

        # set to None if veicolo_fuori_uso (nullable) is None
        # and __fields_set__ contains the field
        if self.veicolo_fuori_uso is None and "veicolo_fuori_uso" in self.__fields_set__:
            _dict['veicolo_fuori_uso'] = None

        # set to None if veicolo_fuori_uso_reg_pubblica_sicurezza (nullable) is None
        # and __fields_set__ contains the field
        if self.veicolo_fuori_uso_reg_pubblica_sicurezza is None and "veicolo_fuori_uso_reg_pubblica_sicurezza" in self.__fields_set__:
    ...
    def from_dict(cls, obj: dict) -> DatiRifiutoModel:
        ...
        _obj = DatiRifiutoModel.parse_obj({
            ...
            "veicolo_fuori_uso_reg_pubblica_sicurezza": VeicoloFuoriUsoRegPubblicaSicurezzaModel.from_dict(obj.get("veicolo_fuori_uso_reg_pubblica_sicurezza")) if obj.get("veicolo_fuori_uso_reg_pubblica_sicurezza") is not None else None
        })
        return _obj
